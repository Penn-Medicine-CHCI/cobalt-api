...
INSERT INTO patient_order_referral_source VALUES ('PROVIDER', 'Provider');
...
-- Modified to add new patient_order_referral_source_id column
-- Previous definition is in 196-swap-patient-order-view.sql
