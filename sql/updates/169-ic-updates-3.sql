BEGIN;
SELECT _v.register_patch('169-ic-updates-3', NULL, NULL);

drop view v_patient_order;
drop view v_all_patient_order;

-- next_contact_type_id WELCOME_MESSAGE and ASSESSMENT_OUTREACH have their next_contact_scheduled_at timestamps as NULL instead of calculating "today".
-- this is because they are more like overdue indicators than an explicit "this needs to be done at X date and time"
