BEGIN;
SELECT _v.register_patch('105-ic-updates', NULL, NULL);

-- Preparation for altering account table
DROP VIEW v_account;

-- Is this a test account?
ALTER TABLE account ADD COLUMN test_account BOOLEAN NOT NULL DEFAULT FALSE;
...
-- Preparation for altering patient_order table
DROP VIEW v_patient_order;
DROP VIEW v_all_patient_order;

ALTER TABLE patient_order ADD COLUMN test_patient_order BOOLEAN NOT NULL DEFAULT FALSE;

-- Adding
--  test_patient_order BOOLEAN NOT NULL
