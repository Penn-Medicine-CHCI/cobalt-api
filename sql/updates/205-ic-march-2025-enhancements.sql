...
-- Modified to ignore any "skipped" screening sessions (an MHIC can now reset an order if they want a patient to re-take the IC intake/clinical screening flows, which skips any open sessions)
-- Previous definition is in 200-self-referred-patient-orders.sql
