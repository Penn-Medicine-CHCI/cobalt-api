BEGIN;
SELECT _v.register_patch('102-ic-updates', NULL, NULL);

--Modifying behavior of most_recent_episode_closed_within_date_threshold to always return FALSE for closed orders
