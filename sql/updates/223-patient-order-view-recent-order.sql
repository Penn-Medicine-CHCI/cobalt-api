BEGIN;
SELECT _v.register_patch('223-patient-order-view-recent-order', NULL, NULL);

-- Add an index for performance in support of the below update
CREATE INDEX ON patient_order (patient_mrn, institution_id, order_date);
