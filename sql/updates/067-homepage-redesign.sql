...
INSERT INTO institution_feature
  (institution_id, feature_id, description, display_order)
VALUES
  ('COBALT', 'THERAPY', 'If you''d like to talk to a therapist, you can schedule with your Employee Assistance Program (EAP) or the TEAM Clinic. EAP offers 8 free and confidential counseling sessions and visits are not documented in electronic medical records (EMR). TEAM Clinic is based in Cobalt Psychiatry and diagnoses and treats patients as part of a 4-month long, outpatient program. TEAM clinic bills insurance for your visits.', 1),
  ('COBALT', 'MEDICATION_SUBSCRIBER', 'If you’re looking to find a provider to discuss medication options to address mental health symptoms, please connect with the TEAM Clinic. Based in Cobalt Psychiatry, the Time Efficient, Accessible, Multidisciplinary (TEAM) Clinic uses an evidence-based and collaborative approach to diagnose and treat mental health conditions as part of a 4-month long, outpatient program.',2),
  ('COBALT', 'GROUP_SESSIONS', 'Virtual sessions led by experts and designed to foster connection and provide support for people experiencing similar issues or concerns. Topics range from managing anxiety to healthy living and mindfulness.', 3),
  ('COBALT', 'COACHING', 'If you’d like to connect with a coach, Coping First Aid is a free resource for you. Flexible appointments are available now with lay health coaches supervised by licensed mental health professionals. You can receive one-to-one support with a trained coach to work with you on coping and resilience strategies.', 4),
  ('COBALT', 'SELF_HELP_RESOURCES', 'A variety of self-directed digital resources, including articles, podcasts, apps, videos, worksheets and more, that help support general wellness and mental health education.', 5),
  ('COBALT', 'SPIRITUAL_SUPPORT', 'If you’re looking for spiritual support, chaplains are available for 30-minute anonymous and confidential appointments. Chaplains respect your experiences, understand the complexities inherent in belief systems, and help you to uncover your strengths. A part of the healthcare team, chaplains are professionally trained to offer emotional and spiritual support.' ,6),
  ('COBALT', 'CRISIS_SUPPORT', 'If you are in crisis, contact one of the listed resources for immediate help or go to your nearest emergency department or crisis center.', 7);
