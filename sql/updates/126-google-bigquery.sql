...
ALTER TABLE institution ADD COLUMN ga4_property_id VARCHAR;
ALTER TABLE institution ADD COLUMN bigquery_resource_id VARCHAR;
ALTER TABLE institution ADD COLUMN bigquery_event_history_starts_at DATE;
...
CREATE TABLE analytics_event_sync (
...
CREATE TABLE analytics_bigquery_event (
  analytics_bigquery_event_id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  institution_id VARCHAR NOT NULL REFERENCES institution,
