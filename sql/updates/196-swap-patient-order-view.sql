BEGIN;
SELECT _v.register_patch('196-swap-patient-order-view', NULL, NULL);

-- If we need to roll back to the previous view, see declaration in 189-order-extra-demographics.sql
