BEGIN;
SELECT _v.register_patch('090-ic-updates', NULL, NULL);

DROP VIEW v_patient_order;

CREATE TABLE patient_order_resourcing_type (
  patient_order_resourcing_type_id VARCHAR PRIMARY KEY,
  description VARCHAR NOT NULL,
  display_order INTEGER NOT NULL
);

INSERT INTO patient_order_resourcing_type VALUES ('NONE', 'None', 1);
INSERT INTO patient_order_resourcing_type VALUES ('PHONE_CALL', 'Phone Call', 2);
INSERT INTO patient_order_resourcing_type VALUES ('MYCHART_MESSAGE', 'MyChart Message', 3);

ALTER TABLE patient_order ADD COLUMN patient_order_resourcing_type_id VARCHAR NOT NULL REFERENCES patient_order_resourcing_type DEFAULT 'NONE';

-- Add column "patient_order_resourcing_type_id"
