BEGIN;
SELECT _v.register_patch('094-ic-updates', NULL, NULL);

CREATE TABLE distance_unit (
  distance_unit_id VARCHAR PRIMARY KEY,
  description VARCHAR NOT NULL
);

INSERT INTO distance_unit VALUES ('MILE', 'Mile');
INSERT INTO distance_unit VALUES ('KILOMETER', 'Kilometer');

CREATE TABLE patient_order_report_type (
  patient_order_report_type_id VARCHAR PRIMARY KEY,
  description VARCHAR NOT NULL,
  display_order INTEGER NOT NULL
);

INSERT INTO patient_order_report_type VALUES ('PIPELINE', 'Pipeline', 1);
INSERT INTO patient_order_report_type VALUES ('OVERALL_OUTREACH', 'Overall Outreach', 2);
INSERT INTO patient_order_report_type VALUES ('MHIC_OUTREACH', 'MHIC Outreach', 3);

CREATE TABLE patient_order_care_preference (
  patient_order_care_preference_id VARCHAR PRIMARY KEY,
  description VARCHAR NOT NULL,
  display_order INTEGER NOT NULL
);

INSERT INTO patient_order_care_preference VALUES ('IN_PERSON', 'In-Person', 1);
INSERT INTO patient_order_care_preference VALUES ('TELEHEALTH', 'Telehealth', 2);
INSERT INTO patient_order_care_preference VALUES ('NO_PREFERENCE', 'No Preference', 3);

ALTER TABLE patient_order ADD COLUMN patient_order_care_preference_id VARCHAR NOT NULL REFERENCES patient_order_care_preference DEFAULT 'NO_PREFERENCE';
