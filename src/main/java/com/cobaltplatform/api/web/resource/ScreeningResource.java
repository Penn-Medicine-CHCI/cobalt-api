...
public class ScreeningResource {
	...
	@Nonnull
	private final ScreeningFlowApiResponseFactory screeningFlowApiResponseFactory;
	@Nonnull
	...
	@Nonnull
	private final ScreeningApiResponseFactory screeningApiResponseFactory;
	@Nonnull
	private final ScreeningVersionApiResponseFactory screeningVersionApiResponseFactory;
	@Nonnull
	...
	public ScreeningResource(@Nonnull ScreeningService screeningService,
													 ...
													 @Nonnull ScreeningFlowApiResponseFactory screeningFlowApiResponseFactory,
													 ...
													 @Nonnull ScreeningApiResponseFactory screeningApiResponseFactory,
													 @Nonnull ScreeningVersionApiResponseFactory screeningVersionApiResponseFactory,
		...
		requireNonNull(screeningFlowApiResponseFactory);
		...
		requireNonNull(screeningApiResponseFactory);
		requireNonNull(screeningVersionApiResponseFactory);
		...
		this.screeningFlowApiResponseFactory = screeningFlowApiResponseFactory;
		...
		this.screeningApiResponseFactory = screeningApiResponseFactory;
		this.screeningVersionApiResponseFactory = screeningVersionApiResponseFactory;
	...
	@GET("/screening-flows")
	@AuthenticationRequired
	public ApiResponse screeningFlows(@Nonnull @QueryParameter ScreeningFlowTypeId screeningFlowTypeId) {
		requireNonNull(screeningFlowTypeId);

		InstitutionId institutionId = getCurrentContext().getInstitutionId();
		List<ScreeningFlow> screeningFlows = getScreeningService().findScreeningFlowsByInstitutionIdAndScreeningFlowTypeId(institutionId, screeningFlowTypeId);

		return new ApiResponse(new HashMap<String, Object>() {{
			put("screeningFlows", screeningFlows.stream()
					.map(screeningFlow -> getScreeningFlowApiResponseFactory().create(screeningFlow))
					.collect(Collectors.toList()));
		}});
	}
	...
	public ApiResponse screeningQuestionContext(@Nonnull @PathParameter ScreeningQuestionContextId screeningQuestionContextId) {
		...
		ScreeningVersion screeningVersion = getScreeningService().findScreeningVersionById(screeningQuestion.getScreeningVersionId()).get();
		Screening screening = getScreeningService().findScreeningById(screeningVersion.getScreeningId()).get();
		...
		return new ApiResponse(new HashMap<String, Object>() {{
			...
			put("screening", getScreeningApiResponseFactory().create(screening));
			put("screeningVersion", getScreeningVersionApiResponseFactory().create(screeningVersion));
	...
	@Nonnull
	protected ScreeningFlowApiResponseFactory getScreeningFlowApiResponseFactory() {
		return this.screeningFlowApiResponseFactory;
	}
	...
	@Nonnull
	protected ScreeningApiResponseFactory getScreeningApiResponseFactory() {
		return this.screeningApiResponseFactory;
	}

	@Nonnull
	protected ScreeningVersionApiResponseFactory getScreeningVersionApiResponseFactory() {
		return this.screeningVersionApiResponseFactory;
	}
