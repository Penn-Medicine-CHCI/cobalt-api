 ...
 */
@NotThreadSafe
public class CourseSessionUnitStatus {
	@Nullable
	...
	public String toString() {
		return format("%s{courseSessionUnitStatusId=%s, description=%s}", getClass().getSimpleName(), getCourseSessionUnitStatusId().name(), getDescription());
	}
