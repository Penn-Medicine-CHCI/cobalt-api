 ...
 */
@NotThreadSafe
public class ClientDeviceActivityType {
	@Nullable
	private ClientDeviceActivityTypeId clientDeviceActivityTypeId;
	@Nullable
	private String description;

	public enum ClientDeviceActivityTypeId {
		ENTERED_FOREGROUND,
		ENTERED_BACKGROUND;
	}
	...
	public String toString() {
		return format("%s{clientDeviceActivityTypeId=%s, description=%s}", getClass().getSimpleName(),
				getClientDeviceActivityTypeId(), getDescription());
	}
