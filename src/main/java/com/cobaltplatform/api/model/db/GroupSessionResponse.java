...
public class GroupSessionResponse {
	@Nullable
	private UUID groupSessionResponseId;
	@Nullable
	...
	public void setGroupSessionResponseId(@Nullable UUID groupSessionResponseId) {
		this.groupSessionResponseId = groupSessionResponseId;
	}
