...
public class AppointmentReasonType {
	...
	public enum AppointmentReasonTypeId {
		MHIC_SELF_SCHEDULE_INITIAL,
		MHIC_SELF_SCHEDULE_FOLLOWUP,
		NOT_SPECIFIED
	}

	@Override
	public String toString() {
		return format("%s{appointmentReasonTypeId=%s, description=%s}", getClass().getSimpleName(), getAppointmentReasonTypeId(), getDescription());
	}
