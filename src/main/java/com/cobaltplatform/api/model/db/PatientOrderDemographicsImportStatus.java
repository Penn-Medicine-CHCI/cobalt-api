 ...
 */
@NotThreadSafe
public class PatientOrderDemographicsImportStatus {
	@Nullable
	private PatientOrderDemographicsImportStatusId patientOrderDemographicsImportStatusId;
	@Nullable
	private String description;

	public enum PatientOrderDemographicsImportStatusId {
		PENDING,
		IMPORTED,
		IMPORT_FAILED
	}
	...
	public String toString() {
		return format("%s{patientOrderDemographicsImportStatusId=%s, description=%s}", getClass().getSimpleName(), getPatientOrderDemographicsImportStatusId(), getDescription());
	}
