 ...
 */
@NotThreadSafe
public class PatientOrderSafetyPlanningStatus {
	@Nullable
	private PatientOrderSafetyPlanningStatusId patientOrderSafetyPlanningStatusId;
	@Nullable
	private String description;

	public enum PatientOrderSafetyPlanningStatusId {
		UNKNOWN,
		NONE_NEEDED,
		NEEDS_SAFETY_PLANNING,
		CONNECTED_TO_SAFETY_PLANNING
	}

	@Override
	public String toString() {
		return format("%s{patientOrderSafetyPlanningStatusId=%s, description=%s}", getClass().getSimpleName(), getPatientOrderSafetyPlanningStatusId(), getDescription());
	}
