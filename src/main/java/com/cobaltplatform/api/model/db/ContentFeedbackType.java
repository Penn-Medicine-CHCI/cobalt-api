 ...
 */
@NotThreadSafe
public class ContentFeedbackType {
	@Nullable
	private ContentFeedbackTypeId contentFeedbackTypeId;
	@Nullable
	private String description;

	public enum ContentFeedbackTypeId {
		THUMBS_UP,
		THUMBS_DOWN
	}
	...
	public String toString() {
		return format("%s{contentFeedbackTypeId=%s, description=%s}", getClass().getSimpleName(), getContentFeedbackTypeId(), getDescription());
	}
