 ...
 */
@NotThreadSafe
public class GroupSessionSuggestion {
	@Nullable
	private UUID groupSessionSuggestionId;
	@Nullable
	...
	public void setGroupSessionSuggestionId(@Nullable UUID groupSessionSuggestionId) {
		this.groupSessionSuggestionId = groupSessionSuggestionId;
	}
