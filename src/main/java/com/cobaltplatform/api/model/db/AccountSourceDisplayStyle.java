 ...
 */
@NotThreadSafe
public class AccountSourceDisplayStyle {
	@Nullable
	private AccountSourceDisplayStyleId accountSourceDisplayStyleId;
	@Nullable
	private String description;

	public enum AccountSourceDisplayStyleId {
		PRIMARY,
		SECONDARY,
		TERTIARY
	}
	...
	public String toString() {
		return format("%s{accountSourceDisplayStyleId=%s, description=%s}", getClass().getSimpleName(),
				getAccountSourceDisplayStyleId(), getDescription());
	}
