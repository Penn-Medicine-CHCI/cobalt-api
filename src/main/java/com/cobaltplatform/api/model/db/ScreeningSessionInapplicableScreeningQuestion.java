 ...
 */
@NotThreadSafe
public class ScreeningSessionInapplicableScreeningQuestion {
	@Nullable
	private UUID screeningSessionInapplicableScreeningQuestionId;
	@Nullable
	...
	@Nullable
	public UUID getScreeningSessionInapplicableScreeningQuestionId() {
		return this.screeningSessionInapplicableScreeningQuestionId;
	}

	public void setScreeningSessionInapplicableScreeningQuestionId(@Nullable UUID screeningSessionInapplicableScreeningQuestionId) {
		this.screeningSessionInapplicableScreeningQuestionId = screeningSessionInapplicableScreeningQuestionId;
	}
