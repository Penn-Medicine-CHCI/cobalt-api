 ...
 */
@NotThreadSafe
public class ScreeningFlowSkipType {
	@Nullable
	private ScreeningFlowSkipTypeId screeningFlowSkipTypeId;
	@Nullable
	private String description;

	public enum ScreeningFlowSkipTypeId {
		SKIP,
		EXIT
	}
	...
	public String toString() {
		return format("%s{screeningFlowSkipTypeId=%s, description=%s}", getClass().getSimpleName(), getScreeningFlowSkipTypeId().name(), getDescription());
	}
