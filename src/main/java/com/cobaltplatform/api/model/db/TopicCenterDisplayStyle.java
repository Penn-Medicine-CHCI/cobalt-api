 ...
 */
@NotThreadSafe
public class TopicCenterDisplayStyle {
	@Nullable
	private TopicCenterDisplayStyleId topicCenterDisplayStyleId;
	@Nullable
	private String description;

	public enum TopicCenterDisplayStyleId {
		DEFAULT,
		FEATURED
	}
	...
	public String toString() {
		return format("%s{topicCenterDisplayStyleId=%s, description=%s}", getClass().getSimpleName(), getTopicCenterDisplayStyleId(), getDescription());
	}
