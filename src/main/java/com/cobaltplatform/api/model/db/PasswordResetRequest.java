...
public class PasswordResetRequest {
	...
	@Nullable
	public UUID getPasswordResetRequestId() {
		return passwordResetRequestId;
	}

	public void setPasswordResetRequestId(@Nullable UUID passwordResetRequestId) {
	...
	public void setExpirationTimestamp(@Nullable Instant expirationTimestamp) {
