 ...
 */
@NotThreadSafe
public class InstitutionBlurbType {
	@Nullable
	private InstitutionBlurbTypeId institutionBlurbTypeId;
	@Nullable
	private String description;

	public enum InstitutionBlurbTypeId {
		INTRO,
		TEAM,
		ABOUT
	}
	...
	public String toString() {
		return format("%s{institutionBlurbTypeId=%s, description=%s}", getClass().getSimpleName(), getInstitutionBlurbTypeId(), getDescription());
	}
