...
public class AccountInvite {
	...
	@Nullable
	private UUID accountInviteCode;
	@Nullable
	...
	@Nullable
	public UUID getAccountInviteCode() {
		return accountInviteCode;
	}

	public void setAccountInviteCode(@Nullable UUID accountInviteCode) {
		this.accountInviteCode = accountInviteCode;
	}
}