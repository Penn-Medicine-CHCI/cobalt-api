 ...
 */
@NotThreadSafe
public class GroupSessionRequestStatus {
	@Nullable
	private GroupSessionRequestStatusId groupSessionRequestStatusId;
	@Nullable
	private String description;

	public enum GroupSessionRequestStatusId {
		NEW,
		ADDED,
		ARCHIVED,
		DELETED
	...
	public String toString() {
		return format("%s{groupSessionRequestStatusId=%s, description=%s}", getClass().getSimpleName(), getGroupSessionRequestStatusId(), getDescription());
	}
