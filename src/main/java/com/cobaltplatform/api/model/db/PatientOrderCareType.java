 ...
 */
@NotThreadSafe
public class PatientOrderCareType {
	@Nullable
	...
	public String toString() {
		return format("%s{patientOrderCareTypeId=%s, description=%s}", getClass().getSimpleName(), getPatientOrderCareTypeId(), getDescription());
	}
