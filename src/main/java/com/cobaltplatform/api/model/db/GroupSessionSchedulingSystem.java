 ...
 */
@NotThreadSafe
public class GroupSessionSchedulingSystem {
	@Nullable
	private GroupSessionSchedulingSystemId groupSessionSchedulingSystemId;
	@Nullable
	private String description;

	public enum GroupSessionSchedulingSystemId {
		COBALT,
		EXTERNAL
	}
	...
	public String toString() {
		return format("%s{groupSessionSchedulingSystemId=%s, description=%s}", getClass().getSimpleName(), getGroupSessionSchedulingSystemId().name(), getDescription());
	}
