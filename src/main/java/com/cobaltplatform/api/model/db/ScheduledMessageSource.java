 ...
 */
@NotThreadSafe
public class ScheduledMessageSource {
	@Nullable
	private ScheduledMessageSourceId scheduledMessageSourceId;
	@Nullable
	private String description;

	public enum ScheduledMessageSourceId {
		SYSTEM,
		MANUAL
	}
	...
	public String toString() {
		return format("%s{scheduledMessageSourceId=%s, description=%s}", getClass().getSimpleName(), getScheduledMessageSourceId(), getDescription());
	}
