 ...
 */
@NotThreadSafe
public class EpicAppointmentFilter {
	@Nullable
	...
	public String toString() {
		return format("%s{epicAppointmentFilterId=%s, description=%s}", getClass().getSimpleName(), getEpicAppointmentFilterId(), getDescription());
	}
