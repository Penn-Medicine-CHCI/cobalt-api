 ...
 */
@NotThreadSafe
public class GroupSessionSystem {
	@Nullable
	private GroupSessionSystemId groupSessionSystemId;
	@Nullable
	private String description;

	public enum GroupSessionSystemId {
		NATIVE,
		ACUITY;
	}
	...
	public String toString() {
		return format("%s{groupSessionSystemId=%s, description=%s}", getClass().getSimpleName(), getGroupSessionSystemId(), getDescription());
	}
