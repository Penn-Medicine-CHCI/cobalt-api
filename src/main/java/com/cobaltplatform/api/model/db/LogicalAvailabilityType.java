 ...
 */
@NotThreadSafe
public class LogicalAvailabilityType {
	@Nullable
	private LogicalAvailabilityTypeId logicalAvailabilityTypeId;
	@Nullable
	private String description;

	public enum LogicalAvailabilityTypeId {
		OPEN,
		BLOCK
	}
	...
	public String toString() {
		return format("%s{logicalAvailabilityTypeId=%s, description=%s}", getClass().getSimpleName(), getLogicalAvailabilityTypeId(), getDescription());
	}
