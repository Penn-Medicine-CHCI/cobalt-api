 ...
 */
@NotThreadSafe
public class AnalyticsSyncStatus {
	@Nullable
	...
	public String toString() {
		return format("%s{analyticsSyncStatusId=%s, description=%s}", getClass().getSimpleName(), getAnalyticsSyncStatusId().name(), getDescription());
	}
