 ...
 */
@NotThreadSafe
public class PatientOrderResourcingStatus {
	@Nullable
	private PatientOrderResourcingStatusId patientOrderResourcingStatusId;
	@Nullable
	private String description;

	public enum PatientOrderResourcingStatusId {
		UNKNOWN,
		NONE_NEEDED,
		NEEDS_RESOURCES,
		SENT_RESOURCES
	...
	public String toString() {
		return format("%s{patientOrderResourcingStatusId=%s, description=%s}", getClass().getSimpleName(), getPatientOrderResourcingStatusId(), getDescription());
	}
