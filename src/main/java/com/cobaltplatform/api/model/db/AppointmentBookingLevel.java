 ...
 */
@NotThreadSafe
public class AppointmentBookingLevel {
	@Nullable
	private AppointmentBookingLevelId appointmentBookingLevelId;
	@Nullable
	private String description;

	public enum AppointmentBookingLevelId {
		PROVIDER,
		CLINIC
	}
	...
	public String toString() {
		return format("%s{appointmentBookingLevelId=%s, description=%s}", getClass().getSimpleName(),
				getAppointmentBookingLevelId().name(), getDescription());
	}
