 ...
 */
@NotThreadSafe
public class AnalyticsVendor {
	@Nullable
	private AnalyticsVendorId analyticsVendorId;
	@Nullable
	private String description;

	public enum AnalyticsVendorId {
		GOOGLE_BIGQUERY,
		GOOGLE_GA4,
		MIXPANEL,
		AMPLITUDE
	...
	public String toString() {
		return format("%s{analyticsVendorId=%s, description=%s}", getClass().getSimpleName(), getAnalyticsVendorId().name(), getDescription());
	}
