...
public class ScheduledMessageStatus {
	...
	public enum ScheduledMessageStatusId {
		PENDING,
		PROCESSED,
		CANCELED,
		ERROR
	...
	public String toString() {
		return format("%s{scheduledMessageStatusId=%s, description=%s}", getClass().getSimpleName(), getScheduledMessageStatusId(), getDescription());
	}
