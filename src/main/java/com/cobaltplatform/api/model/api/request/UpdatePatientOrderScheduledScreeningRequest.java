 ...
 */
@NotThreadSafe
public class UpdatePatientOrderScheduledScreeningRequest {
	@Nullable
	...
	@Nullable
	private String scheduledTime; // Manually parse string from the UI
	@Nullable
	...
	public void setScheduledDate(@Nullable LocalDate scheduledDate) {
