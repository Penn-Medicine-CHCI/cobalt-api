...
public class PatientOrderScheduledMessageApiResponse {
	...
	public PatientOrderScheduledMessageApiResponse(@Nonnull Formatter formatter,
		...
		this.processedAtDescription = patientOrderScheduledMessage.getProcessedAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getProcessedAt());
		this.canceledAt = patientOrderScheduledMessage.getCanceledAt();
		this.canceledAtDescription = patientOrderScheduledMessage.getCanceledAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getCanceledAt());
		this.erroredAt = patientOrderScheduledMessage.getErroredAt();
		this.erroredAtDescription = patientOrderScheduledMessage.getErroredAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getErroredAt());
		this.sentAt = patientOrderScheduledMessage.getSentAt();
		this.sentAtDescription = patientOrderScheduledMessage.getSentAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getSentAt());
		this.deliveredAt = patientOrderScheduledMessage.getDeliveredAt();
		this.deliveredAtDescription = patientOrderScheduledMessage.getDeliveredAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getDeliveredAt());
		this.deliveryFailedAt = patientOrderScheduledMessage.getDeliveryFailedAt();
		this.deliveryFailedAtDescription = patientOrderScheduledMessage.getDeliveryFailedAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getDeliveryFailedAt());
		...
		this.complaintRegisteredAtDescription = patientOrderScheduledMessage.getComplaintRegisteredAt() == null ? null : formatter.formatTimestampDescription(patientOrderScheduledMessage.getComplaintRegisteredAt());
