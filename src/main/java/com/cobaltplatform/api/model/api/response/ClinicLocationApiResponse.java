 ...
 */
@Immutable
public class ClinicLocationApiResponse {
	@Nullable
	private final UUID clinicLocationId;
	@Nullable
	...
	public ClinicLocationApiResponse(@Nonnull ClinicLocation clinicLocation,
																	 @Nullable Address address,
																	 @Nonnull Formatter formatter) {
		requireNonNull(clinicLocation);
		requireNonNull(formatter);

		this.clinicLocationId = clinicLocation.getClinicLocationId();
