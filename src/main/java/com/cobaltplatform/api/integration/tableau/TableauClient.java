 ...
 */
@ThreadSafe
public interface TableauClient {
	@Nonnull
	String generateDirectTrustJwt(@Nonnull AccessTokenRequest accessTokenRequest);

	@Nonnull
	String authenticateUsingDirectTrustJwt(@Nonnull String jwt,
