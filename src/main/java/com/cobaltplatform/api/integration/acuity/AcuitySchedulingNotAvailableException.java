 ...
 */
@ThreadSafe
public class AcuitySchedulingNotAvailableException extends AcuitySchedulingException {
	@Nonnull
	private final AcuityError acuityError;

	public AcuitySchedulingNotAvailableException(@Nonnull String message,
