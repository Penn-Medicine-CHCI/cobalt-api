 ...
 */
@NotThreadSafe
public class SerializableCallMessage {
	@Nonnull
	...
	@Nonnull
	private CallMessageTemplate messageTemplate;
	@Nonnull
	...
	public void setMessageTemplate(@Nonnull CallMessageTemplate messageTemplate) {
