 ...
 */
@ThreadSafe
public class CallMessageSerializer implements MessageSerializer<CallMessage> {
	@Nonnull
	...
	@Inject
	public CallMessageSerializer(@Nonnull JsonMapper jsonMapper,
	...
	@Nonnull
	@Override
	public String serializeMessage(@Nonnull CallMessage callMessage) {
		...
		serializableCallMessage.setToNumber(callMessage.getToNumber());

		return getJsonMapper().toJson(serializableCallMessage);
	}

	@Nonnull
	@Override
	public CallMessage deserializeMessage(@Nonnull String serializedMessage) {
		...
		return new CallMessage.Builder(serializableCallMessage.getMessageId(),
				...
				.messageContext(serializableCallMessage.getMessageContext())
				.build();
	}
